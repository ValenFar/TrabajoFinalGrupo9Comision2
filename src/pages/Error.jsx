...
const Error = () => {
  return (
    <Container className="d-flex justify-content-center align-items-center min-vh-100">
      <Card
        className="p-4 bg-light shadow-lg text-center animate__animated animate__fadeIn"
      ...
      >
        ...
        <p className="mb-4 px-3 text-muted">
          Este error suele ocurrir cuando la URL ingresada no coincide con
          nuestras rutas. Verificá que esté bien escrita o volvé al inicio.
        </p>
